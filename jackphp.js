...
function runJack(){
	...
	$(function(){
		...
		var opts = "resizable=no, scrollbars=no, titlebar=no, toolbar=no, location=no, status=no, top=400, left=400, height=1,width=20";
...
//$.getJSON('urls-jack.js').done(function(data){
...
Jack.spin = function(value, replaceLinks){
	...
	if(typeof(ret) == "string"){
		...
		if(replaceLinks)
			ret = ret.replace("%link%", 'http://tinyurl.com/mqpdotl'	
							);
	}
	return ret;
}
